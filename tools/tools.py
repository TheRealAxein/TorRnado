...
def banner():
	...
	info = " "*13+colored("[", "blue")+"Developers :"+colored("AXEIN", "red")
...
def donate():
	...
	print("")
	print(colored("DonationAlerts", "red"))
	print("└"+colored("soon", "cyan"))
...
def start_input():
	...
	if pr != None:
		while True:
			...
			print("└"+colored("Общедоступный прокси используют все пользователи TorRnado-Bomber", "cyan"))
			print()
			print(colored("[2]", "red"), colored("Свой прокси", "green"))
			print("└"+colored("Ваш прокси обязательно должен иметь протокол HTTP или HTTPS с поддержкой ipv4 и страну вашего номера. HERE: 20.210.113.32:80", "cyan"))
			print()
